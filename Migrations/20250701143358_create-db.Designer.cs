...
<<<<<<<< HEAD:Migrations/20250701133154_createDb.Designer.cs
    [Migration("20250701133154_createDb")]
    partial class createDb
========
    [Migration("20250701143358_create-db")]
    partial class createdb
>>>>>>>> 791f5454acf9159e3f5d7ce9cf5de197d2d7a63c:Migrations/20250701143358_create-db.Designer.cs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AspnetCoreMvcFull.Models.BinReportImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("BinReportId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("BinReportId");

                    b.ToTable("BinReportImages");
                });
            ...
            modelBuilder.Entity("AspnetCoreMvcFull.Models.BinReportImage", b =>
                {
                    b.HasOne("AspnetCoreMvcFull.Models.BinReport", "BinReport")
                        .WithMany("BinReportImages")
                        .HasForeignKey("BinReportId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BinReport");
                });
